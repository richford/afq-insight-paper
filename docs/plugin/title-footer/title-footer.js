...
title_footer.initialize=function(title, authors, img, background)
{
	...
	title_footer.setAttribute(
		'style',
		'background:'+this.background+'; display: flex;'
	);

	var text_div=document.createElement('div');
	text_div.setAttribute('style','flex-grow: 1;');
	var title_footer_h=document.createElement('h4');
	text_div.appendChild(title_footer_h);
	var a_element=document.createElement('a');
	a_element.setAttribute('href','#/0');
	a_element.appendChild(document.createTextNode(this.title));
	title_footer_h.appendChild(a_element);
	var p_element=document.createElement('p');
	p_element.appendChild(document.createTextNode(this.authors));
	text_div.appendChild(p_element);
	title_footer.appendChild(text_div);


	if (img)
	{
		var img_element=document.createElement('img');
		img_element.setAttribute('src', this.img);
		img_element.setAttribute('alt', 'Institution logo');
		img_element.setAttribute('style', 'align-self: flex-end;');
