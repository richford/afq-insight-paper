...
\replaced{four other models: a pure lasso model, an elastic net model, a
...
\replaced{These models achieved accuracies of 76\%, 76\%, 79.5\%, and 71.5\%
...
obtained using \replaced{the pure lasso, elastic net, bundle-mean lasso, and
...
using the same cross-validation strategy used to assess the SGL. \added{The
