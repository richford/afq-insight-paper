...
right CST, plotted over the FA values for the control and ALS subject groups (see supplemental Figs S1 and S2 for tract profiles of all 18 tracts in these groups).
...
imaging (DKI) \cite{jensen2005diffusion} for the HBN and Cam-CAN datasets see supplemental Figs S3 to S8 for the full tract profile information in all tracts/datasets.
...
\begin{figure}[b!]
    ...
    \phantomcaption{\label{fig:methods}}
\end{figure}
...
\paragraph{Figure 1: Tractometry data flow}
...
\paragraph{Figure 2: PCR-SGL accurately and interpretably predicts ALS diagnosis.}
...
\paragraph{Figure 3: Predicting age with tractometry and SGL.}
...
\paragraph{Figure 4: Model performance across all datasets.}
...
\paragraph{Figure 5: Nested cross-validation.}
