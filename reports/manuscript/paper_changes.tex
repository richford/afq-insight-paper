...
\added{This is unlike many previous models of white matter differences (e.g., TBSS \cite{} and connectometry \cite{}) that are ``encoding'' models, where differences between individuals and groups are tested as hypotheses about differences in their brain features (i.e., in their tract profiles; the distinction between ``encoding'' and ``decoding'' and the terms stem from functional MRI literature \cite{Naselaris2011-ss})}.
