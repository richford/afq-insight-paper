...
\\
\bigskip
\textbf{1} eScience Institute, University of Washington, Seattle, \replaced{Washington, United States of America}{WA, USA}
\\
\textbf{2} Graduate School of Education and Division of Developmental and Behavioral Pediatrics, Stanford University, Stanford, \replaced{California, United States of America}{CA, USA}
\\
\textbf{3} Department of Biostatistics, University of Washington, Seattle, \replaced{Washington, United States of America}{WA, USA}
\\
\textbf{4} Department of Psychology, University of Washington, Seattle, \replaced{Washington, United States of America}{WA, USA}
\\
\bigskip
...
\begin{figure}[b!]
    ...
    {\bf \deleted{Figure 1}: Tractometry data flow}
...
(see \replaced{S1 Fig and S2 Fig}{Supporting Figures S1 and S2} for tract profiles of all 18 tracts in these groups).
...
\begin{figure}[b!]
    ...
    \caption{
    {\bf \deleted{Figure 2}: PCR-SGL accurately and interpretably predicts ALS diagnosis.}
...
see \replaced{S3 Fig to S8 Fig}{Supporting Figures S3 to S8} for the full tract profile information in all tracts/datasets.
...
and supporing figures in \replaced{S3 Fig to S8 Fig}{S1 Appendix}).
...
\begin{figure}[b!]
    ...
    \phantomcaption{%
    {\bf \deleted{Figure 3}: Predicting age with tractometry and SGL.}
...
\begin{figure}[b!]
    ...
    \caption{%
    {\bf \deleted{Figure 4}: Model performance across all datasets.}
...
We present age quintile bundle profiles and SGL \protect$\beta$ coefficients for all four datasets in \replaced{S3 Fig to S8 Fig}{the Supporting Information}. For age regression, substantial differences between the datasets preclude generalization across all three:
\begin{enumerate*}[%
    label=(\roman*),%
    before=\unskip{: },%
    itemjoin={{, }},%
...
area: Rutgers University Brain Imaging Center and the CitiGroup Cornell Brain Imaging Center. Age distributions of participants in the different sites are in \replaced{S9 Fig}{Supporting Figure S9}.
...
tracts, which are enumerated in \replaced{S1 Fig}{Figure S1}, were identified
...
which are enumerated in \replaced{S1 Fig}{the Supporting Information}.
...
\begin{figure}[h!]
    ...
    \phantomcaption{
    {\bf \deleted{Figure 5}: Nested cross-validation.}
...
\paragraph{\replaced{S1 Fig}{Figure S1: Bundle profiles and regression coefficients for the ALS dataset FA.}}
\label{S1_Fig}
\added{{\bf Bundle profiles and regression coefficients for the ALS dataset FA.}}
...
\deleted{We use these acronyms throughout the Supporting Information.}
...
\paragraph*{\replaced{S2 Fig.}{Figure S2: Bundle profiles and regression coefficients for the ALS dataset MD. The scale of the $\hat{\beta}$-axis is identical to that used in Figure S1, to facilitate the comparison of the relative importance of each metric.}}
\label{S2_Fig}
\added{{\bf Bundle profiles and regression coefficients for the ALS dataset MD.}}
\added{The scale of the $\hat{\beta}$-axis is identical to that used in S1 Fig, to facilitate the comparison of the relative importance of each metric.}

\paragraph*{\replaced{S3 Fig.}{Figure S3: Bundle profiles and regression coefficients for the WH dataset FA.}}
\label{S3_Fig}
\added{{\bf Bundle profiles and regression coefficients for the WH dataset FA.}}
...
\paragraph*{\replaced{S4 Fig.}{Figure S4: Bundle profiles and regression coefficients for the WH dataset MD.}}
\label{S4_Fig}
\added{{\bf Bundle profiles and regression coefficients for the WH dataset MD.}}
This and \replaced{S3 Fig}{Figure S3} demonstrate that SGL behaves much more like the
...
\paragraph*{\replaced{S5 Fig.}{Figure S5: FA bundle profiles and $\hat{\beta}$ coefficients for age regression in the HBN dataset.}}
\label{S5_Fig}
\added{{\bf FA bundle profiles and $\hat{\beta}$ coefficients for age regression in the HBN dataset.}}
...
\paragraph*{\replaced{S6 Fig.}{Figure S6: MD bundle profiles and $\hat{\beta}$ coefficients for age regression in the HBN dataset.}}
\label{S6_Fig}
\added{{\bf MD bundle profiles and $\hat{\beta}$ coefficients for age regression in the HBN dataset.}}
...
\paragraph*{\replaced{S7 Fig.}{Figure S7: FA bundle profiles and $\hat{\beta}$ coefficients for age regression in the Cam-CAN dataset.}}
\label{S7_Fig}
\added{{\bf FA bundle profiles and $\hat{\beta}$ coefficients for age regression in the Cam-CAN dataset.}}
...
\paragraph*{\replaced{S8 Fig.}{Figure S8: Mean diffusivity (MD) bundle profiles and $\hat{\beta}$ coefficients for age regression in the Cam-CAN dataset.}}
\label{S8_Fig}
\added{{\bf Mean diffusivity (MD) bundle profiles and $\hat{\beta}$ coefficients for age regression in the Cam-CAN dataset.}}

\paragraph*{\replaced{S9 Fig.}{Figure S9: Age distributions are similar between the different HBN sites.}}
\label{S9_Fig}
\added{{\bf Age distributions are similar between the different HBN sites.}}
Rutgers Rutgers University Brain Imaging Center (RU) and the CitiGroup Cornell Brain Imaging Center (CBIC).

\paragraph*{\replaced{S10 Fig.}{Figure S10: FA bundle profiles exhibit strong site differences in the HBN dataset.}}
\label{S10_Fig}
\added{{\bf FA bundle profiles exhibit strong site differences in the HBN dataset.}}

\paragraph*{\replaced{S11 Fig.}{Figure S11: MD bundle profiles exhibit strong site differences in the HBN dataset.}}
\label{S11_Fig}
\added{{\bf MD bundle profiles exhibit strong site differences in the HBN dataset.}}

\paragraph*{\replaced{S12 Fig.}{Figure S12: Site differences in FA are eliminated by ComBat harmonization.}}
\label{S12_Fig}
\added{{\bf Site differences in FA are eliminated by ComBat harmonization.}}

\paragraph*{\replaced{S13 Fig.}{Figure S13: Site differences in MD are eliminated by ComBat harmonization.}}
\label{S13_Fig}
\added{{\bf Site differences in MD are eliminated by ComBat harmonization.}}
